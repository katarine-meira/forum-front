          ...
          <div class="q-ma-md">
            <q-card bordered flat>
              ...
              <q-card-section>
                ...
                <q-list dense>
                  <q-item>
                    <q-item-section>Sobre você</q-item-section>
                  </q-item>
